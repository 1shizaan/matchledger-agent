              ...
              {contactOptions.map((option, index) => (
                ...
                >
                  ...
                  <motion.a
                    ...
                    className={`inline-block px-4 py-2 rounded-lg font-medium transition-all duration-300 ${option.color === 'blue' ? 'bg-blue-500 hover:bg-blue-600' : option.color === 'green' ? 'bg-green-500 hover:bg-green-600' : option.color === 'purple' ? 'bg-purple-500 hover:bg-purple-600' : 'bg-orange-500 hover:bg-orange-600'} text-white`}
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    {option.email}
                  </motion.a>
                  <p className="text-xs text-white/50 mt-2">{option.responseTime}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
